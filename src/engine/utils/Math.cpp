...
namespace starlight {
    ...
    glm::vec3 Math::moveTowards(const glm::vec3 &currentPos, const glm::vec3 &targetPos, float deltaTime, float speed) {
        ...
        glm::vec3 newPosition = currentPos + direction * speed * deltaTime;
